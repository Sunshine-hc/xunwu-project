...
public interface HouseRepository extends PagingAndSortingRepository<House,Long>, JpaSpecificationExecutor<House> {
    ...
    @Query("select distinct house.regionEnName from House as house where house.district =:dit")
    String findAllRegionEnNameByDistrict(@Param(value = "dit")String district);
}
